...
class Queue<T> {
    ...
    /// <summary> Returns the value of the first item in the queue. </summary>
    public T Peek() {
        if (count == 0) {
            Console.WriteLine("Queue is empty");
            return default(T);
    ...
    /// <summary> Prints all values to the console. </summary>
    public void Print() {
        Node p = head;
    ...
    /// <summary> Returns a concatenated string if of type string or char. </summary>
